...
public class PersonCollectionResource {
    ...
    public MeasureResource getHistoryByPidAndType(@PathParam("personId") int id, @PathParam("measureType") String type) {
        return new MeasureResource(uriInfo, request, id, type);
    }
